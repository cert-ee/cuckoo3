    ...
    "web.yaml": {
        ...
        "elasticsearch": {
            ...
            "statistics": {
                ...
                "charts": config.DictList(
                    ...
                    default_val=[
                        {"chart_type": "submissions_line", "time_range": "yearly"},
                        {"chart_type": "submissions_line", "time_range": "monthly"},
                        {"chart_type": "families_bar", "time_range": "weekly"},
                        {"chart_type": "families_line", "time_range": "weekly"},
                        {"chart_type": "targettypes_bar", "time_range": "monthly"},
                        {"chart_type": "categories_bar", "time_range": "monthly"},
                    ],
                ),
            },
        },
        "web": {
            "downloads": {
                ...
                "allowed_subnets": config.String(
                    allow_empty=False, default_val="127.0.0.0/8,10.0.0.0/8"
                ),
            }
        },
    }
