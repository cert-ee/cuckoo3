...
def index(request):
    return render(
        request,
        template_name="compare/index.html.jinja2",
    )
...
def compare(request, task_id1, task_id2):
    ...
    return render(
        request,
        template_name="compare/compare.html.jinja2",
        context={
            "comparison": compared.to_dict(),
            "lefttask": {"report": task1post.to_dict(), "task": task1.to_dict()},
            "righttask": {"report": task2post.to_dict(), "task": task2.to_dict()},
        },
    )
