...
_NETWORKFLOW = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="ts",
            full_name="threemon.NetworkFlow.ts",
            index=0,
            number=7,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="pid",
            full_name="threemon.NetworkFlow.pid",
            index=1,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="procid",
            full_name="threemon.NetworkFlow.procid",
            index=2,
            number=8,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="proto",
            full_name="threemon.NetworkFlow.proto",
            index=3,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="srcip",
            full_name="threemon.NetworkFlow.srcip",
            index=4,
            number=3,
            type=7,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="dstip",
            full_name="threemon.NetworkFlow.dstip",
            index=5,
            number=4,
            type=7,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="srcport",
            full_name="threemon.NetworkFlow.srcport",
            index=6,
            number=5,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="dstport",
            full_name="threemon.NetworkFlow.dstport",
            index=7,
            number=6,
            type=13,
            cpp_type=3,
...
_MASTERSECRET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="ts",
            full_name="threemon.MasterSecret.ts",
            index=0,
            number=6,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="pid",
            full_name="threemon.MasterSecret.pid",
            index=1,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="procid",
            full_name="threemon.MasterSecret.procid",
            index=2,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="arg0",
            full_name="threemon.MasterSecret.arg0",
            index=3,
            number=3,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="arg1",
            full_name="threemon.MasterSecret.arg1",
            index=4,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="arg2",
            full_name="threemon.MasterSecret.arg2",
            index=5,
            number=5,
            type=12,
            cpp_type=9,
...
NetworkFlow = _reflection.GeneratedProtocolMessageType(
    "NetworkFlow",
    (_message.Message,),
    dict(
...
MasterSecret = _reflection.GeneratedProtocolMessageType(
    "MasterSecret",
    (_message.Message,),
    dict(
