...
from common.cuckoo.common.config import cfg


class CuckooProcessingError(Exception):
...
class Snort(Processor):
    ...
    def run(self):
        ...
        self.url = cfg("snort", "snort", subpkg="processing")
        self.timeout = cfg("snort", "conf", subpkg="processing")
